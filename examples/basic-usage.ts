...
async function main() {
  ...
  try {
    ...
    const launchTx = await sdk.write.launchToken({
      ...
      bondingCurveParams: {
        prices: ['110000000', '120000000', '130000000', '140000000', '150000000', '160000000', '170000000', '180000000', '190000000', '200000000'],
        numSteps: '10',
    ...
    const buyQuote = await sdk.read.getBuyQuote(testTokenAddress, amountETHToUseForBuy1);
    ...
    const sellQuote = await sdk.read.getSellQuote(testTokenAddress, amountTokensToSell);
    ...
    const buyQuote2 = await sdk.read.getBuyQuote(testTokenAddress, amountETHToUseForBuy2);
